...
# INPUT / OUTPUT
input_file = "FACEBOOK Jan-01-2023_Dec-31-2023_27202681332649937.xlsx"
output_file = "facebook_posts_clean_2023.csv"
...
expected_cols = [
    ...
    "post_type","is_shared_post","is_crossposted",

    "total_engagement","reactions","comments","shares",

    "total_clicks","link_clicks","other_clicks",
    "video_clicks","photo_clicks",

    "organic_reach","promoted_reach","total_reach",

    "video_views_3s","video_views_1min",
    "organic_video_views_3s","promoted_video_views_3s",

    "seconds_watched","avg_seconds_viewed",

    "ad_impressions","has_promoted_reach"
]

numeric_cols = [
    "duration_sec","total_engagement","reactions","comments","shares",
    "total_clicks","link_clicks","other_clicks","video_clicks","photo_clicks",
    "organic_reach","promoted_reach","total_reach",
    "video_views_3s","video_views_1min",
    "organic_video_views_3s","promoted_video_views_3s",
    "seconds_watched","avg_seconds_viewed",
